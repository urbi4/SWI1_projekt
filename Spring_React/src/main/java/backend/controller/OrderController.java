...
public class OrderController{
    ...
    List<Orders> getAll(){
        ...
        List<Orders> ret = repository.findAll();
    ...
    ArrayList<String> getTimes(@RequestParam(name = "value", required = false, defaultValue = "default") String value) {
        ...
        for (TimeRange timeRange : trList) {
            log.info(timeRange.getTimeOfStart().toString());
...
//        return repository.save(newOrder);
        ...
        try {
            ...
            Orders newOrder = check(order); //TODO
            if(newOrder != null){
            addressRepository.save(newOrder.getPerson().getAddress());
            personRepository.save(newOrder.getPerson());
            vehicleRepository.save(newOrder.getVehicle());
